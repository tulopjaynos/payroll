...
<html>
    ...
    <body style="background:#00162A">
        <nav class="navbar" style="background:#DCDCDC">
		  <div class="container-fluid">
			<div class="navbar-header">
			  <a class="navbar-brand" > <i class="glyphicon glyphicon-qrcode"></i>  OPMS Attendance</a>
			</div>
		<ul class="nav navbar-nav" style="background: ">
			  <!--li class="active"><a href="http://localhost:7882/payroll/index.php"><span class="glyphicon glyphicon-home"></span> Home</a></li>
			  ...
			  <li><a href="attendance.php"><span class="glyphicon glyphicon-time"></span> Check Attendance</a></li>
			</ul-->
			<ul class="nav navbar-nav navbar-right">
			  <!--li><a href="#"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li-->
			  <li><a href="http://localhost:7882/payroll/index.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
			</ul>
		  </div>
		</nav>
       <div class="container">
                  ...
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        if($conn->connect_error){
                           ...
                           $sql ="SELECT * FROM attendance LEFT JOIN wy_employees ON attendance.STUDENTID=wy_employees.emp_code WHERE LOGDATE='$date'";
