...
if(isset($_POST['attendance']))
{
  ...
  if($code == "time-in")
  {
    ...
    $sql = "SELECT * FROM emp_list WHERE emp_id = '$id' AND emp_password = '$pass'";
    ...
    if(!$row = $result->fetch_assoc()) {
      ...
      $sql2 = "SELECT * FROM emp_attendance WHERE employee_id = '$id' AND attendance_date = '$date' AND Password = '$pass'";
...
<div class="login-box">
  <div class="login-logo" style="margin-top: 150px ">
    ...
    <h1 id="time" class="bold" style="font-size: 100px; font-family: sans-serif;"><?php echo $time; ?></h1>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Please Enter Employee ID</p>

      <form method="POST">

        <div class="input-group mb-3">
          <select name="operation" class="form-control" style="width: 150px;height: 25px">
        ...
        <div class="input-group mb-3">
          <input type="text" name="emp_id" class="form-control" placeholder="Employee ID" style="width: 250px; height: 35px">
          <input type="password" name="emp_password" class="form-control" placeholder="Password" style="width: 250px; height: 35px">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-id-cards"></span>
            </div>
          </div>
        </div>
