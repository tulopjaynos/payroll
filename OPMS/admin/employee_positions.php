            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info">
                ...
                <tr style="color: white">
                  ...
                  <td>
                    <button class="btn btn-default btn-flat pos_edit" id="<?php echo $row['pos_id']; ?>" style="background-color: yellow">Edit<i class="fas fa-editt"></i></button>
                    <button class="btn btn-default btn-flat pos_delete" id="<?php echo $row['pos_id']; ?>" style="background-color: pink">Delete<i class="fas fa-trashh"></i></button>
                  </td>
                </tr>
                <?php
                }
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="background-color: silver">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="submit" class="btn btn-primary btn-flat" name="add_position"><i class="fas fa-saves"></i> Save</button>
      </form>
      </div>
    </div>
    <!-- /.modal-content -->
