      ...
      <div class="row">
        <div class="col-12">
          <div class="card" style="background-color: gray">
            <div class="card-body">
              <div align="right">
                <button class="btn btn-default btn-flat" data-toggle="modal" data-target="#modal-default"><i class="fas fa-pluss"></i> New Schedule</button>
              </div><br>
              <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info">
                ...
                <tr style="color: white">
                  ...
                  <td>
                    <button class="btn btn-default btn-flat sched_edit" id="<?php echo $row['sched_id']; ?>" style="background-color: yellow">Edit<i class="fas fa-editt"></i></button>
                    <button class="btn btn-default btn-flat del_sched" id="<?php echo $row['sched_id']; ?>" style="background-color: pink">Delete<i class="fas fa-trashh" ></i></button>
                  </td>
                </tr>
                <?php
                }
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="background-color: silver">
      <div class="modal-header">
        <h4 class="modal-title">New Schedules</h4>
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="submit" class="btn btn-primary btn-flat" name="add_sched"><i class="fas fa-saves"></i> Save</button>
      </form>
      </div>
    </div>
  </div>
...
<div id="sched_modal" class="modal fade" >
     <div class="modal-dialog" role="document">
          <div class="modal-content" style="background-color: #00162A">
               <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabel" style="color: white">Updating...</h5>
                 <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                   <span aria-hidden="true">×</span>
                 </button>
               </div>
               <form method="POST">
               <div class="modal-body" id="sched_details" style="color: white">
               </div>
...
<div id="delete_modal" class="modal fade">
     <div class="modal-dialog" role="document">
          <div class="modal-content" style="background-color: #00162A" >
               ...
               <form method="POST">
               <div class="modal-body" id="delete_details" style="color: silver">
               </div>
               <div class="modal-body"></div>
               <div class="modal-footer justify-content-between">
                 <button type="button" class="btn btn-default btn-flat" data-dismiss="modal"><i class="fas fa-times"></i> Close</button>
                 <button type="submit" class="btn btn-default btn-flat" name="delete_sched"><i class="fas fa-trashh"></i> Delete</button>
               </form>
               </div>
          </div>
     </div>
