    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <h1 style="font-size: 50px;color: silver ">Admin</h1> 
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-flat nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="staff_employee.php" class="nav-link active">
              <!--i class="nav-icon fas fa-sticky-note"></i-->
              <p>
                Staff
              </p>
              ...
              <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info">
                ...
                <tr style="color: white">
                  ...
                  <td>
                    ...
                    <button class="btn btn-default btn-flat pos_delete" id="<?php echo $row['id']; ?>" style="background-color: pink">Delete<i class="fas fa-trashh"></i></button>
                  </td>
                </tr>
                <?php
                }
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="background-color: silver">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="submit" class="btn btn-primary btn-flat" name="add_type"><i class="fas fa-save"></i> Save</button>
      </form>
      </div>
    </div>
    <!-- /.modal-content -->
