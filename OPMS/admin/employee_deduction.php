        ...
        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-flat nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="employee_deduction.php" class="nav-link active">
              <!--i class="nav-icon fas fa-sticky-note"></input-group-sm-->
              <p>
                Deduction
              </p>
            </a>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card" style="background-color: gray">
            <div class="card-body">
              <div align="right">
                <button class="btn btn-default btn-flat" data-toggle="modal" data-target="#modal-default">Add Deduction<i class="fas fa-pluss"></i></button>
              </div><br>
              <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info">
                ...
                <tr style="color: white">
                  ...
                  <td>
                    <button class="btn btn-default btn-flat deduct_edit" id="<?php echo $row['deduct_id']; ?>" style="background-color: yellow">Edit<i class="fas fa-editt"></i></button>
                    <button class="btn btn-default btn-flat delete_deduct" id="<?php echo $row['deduct_id']; ?>" style="background-color: pink">Delete<i class="fas fa-trashh"></i></button>
                  </td>
                </tr>
                <?php
                }
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="background-color: silver">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="submit" class="btn btn-primary btn-flat" name="add_deduct"><i class="fas fa-saves"></i> Save</button>
      </form>
      </div>
    </div>
  </div>
