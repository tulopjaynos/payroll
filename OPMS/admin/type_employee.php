      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-flat nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="type_employee.php" class="nav-link active">
              <!--i class="nav-icon fas fa-sticky-note"></i-->
              <p>
                Type of Employee
              </p>
  ...
  <div class="content-wrapper" style="background-color: silver">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Type of Employee</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Type of Employee</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card" style="background-color: gray">
            <div class="card-body">
              <div align="right">
                <button class="btn btn-default btn-flat" data-toggle="modal" data-target="#modal-default"><i class="fas fa-pluss"></i> New</button>
              </div><br>
              <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info">
                ...
                ?>
                <tr style="color: white">
                  <td><?php echo $row['typeofemployee']; ?></td>
                  <td><?php echo $row['type']; ?></td>
                  <td>
                    <button class="btn btn-default btn-flat pos_edit" id="<?php echo $row['id']; ?>" style="background-color: yellow">Edit<i class="fas fa-editt"></i></button>
                    <button class="btn btn-default btn-flat pos_delete" name="type_delete"id="<?php echo $row['id']; ?>" style="background-color: pink">Delete<i class="fas fa-trashh"></i></button>
                  </td>
                </tr>
                <?php
                }
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="background-color: silver">
      <div class="modal-header">
        <h4 class="modal-title">Add Type of Employee</h4>
      ...
      <div class="modal-body">
        <form method="POST">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" name="employee_type" placeholder="" required>
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="submit" class="btn btn-primary btn-flat" name="add_type"><i class="fas fa-saves"></i> Save</button>
      </form>
      </div>
    </div>
    <!-- /.modal-content -->
     ...
     <div class="modal-dialog" role="document">
          <div class="modal-content">
               ...
               <div class="modal-footer justify-content-between">
                 ...
                 <button type="submit" class="btn btn-primary btn-flat" name="type_update"><i class="fas fa-check"></i> Update</button>
               </form>
               </div>
          </div>
     </div>
...
<div id="pos_delete_modal" class="modal fade">
     <div class="modal-dialog" role="document">
          <div class="modal-content">
               ...
               <div class="modal-footer justify-content-between">
                 <button type="button" class="btn btn-default btn-flat" data-dismiss="modal"><i class="fas fa-times"></i> Close</button>
                 <button type="submit" class="btn btn-danger btn-flat" name="type_delete"><i class="fas fa-trash"></i> Delete</button>
               </form>
               </div>
          </div>
     </div>
...
$(document).ready(function(){
     $('.pos_delete').click(function(){
          var type_del_id = $(this).attr("id");
          $.ajax({
               url:"controller.php",
               method:"post",
               data:{type_del_id:type_del_id},
               success:function(data){
