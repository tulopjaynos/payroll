...
<?php
	$payroll=$conn->query("SELECT p.*,concat(e.emp_lname,', ',e.emp_fname,' ',e.emp_position) as ename,e.emp_id FROM emp_attendance p inner join emp_list e on e.emp_id = p.emp_card  where p.employee_id=".$_GET['id']);
