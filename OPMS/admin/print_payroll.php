            ...
            <div class="box-header with-border">
              <div align="right" style="float: right;"><br>
                ...
                <div class="input-group">
                  ...
                  <button class="btn btn-default btn-flat" name="apply_date"><i class="fa fa-checks"></i> Apply Date</button> &nbsp;
                </div>
                </form>
              </div>
            </div>
                ...
                <tr style="color: white">
                  ...
                  <td>
                    <form method="POST" target="_blank">
                      <button type="submit" value="<?php echo $row['emp_code']; ?>" class="btn btn-default" name="new_payslip"><i class="fas fa-prints"></i> Payslip</button>
                    </form>
                  </td>
                </tr>
                <?php
