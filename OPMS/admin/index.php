...
<div class="login-box" style="margin-top: 150px">
  <div class="login-logo" style="background-color: #00162A">
    <p class="bold" style="color: white; font-family: sans-serif;">Accounting Login</p>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body" style="background-color: #00162A">
      <p class="login-box-msg" style="color:white; font-family: sans-serif;">Sign in to start your session</p>
      ...
      <form method="POST">
        ...
        <div align="right">
          <button type="submit" class="btn btn-default btn-flat" name="Sign_in"><i class="fas fa-sign-in-altt"></i> Sign In</button>
        </div>
