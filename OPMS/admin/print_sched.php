          ...
          <div class="card" style="background-color: gray">
            <div class="card-body">
              <div align="right">
                ...
                <button class="btn btn-default btn-flat" onclick="frames['printsched'].print()"><i class="fas fa-prints"></i> Print</button>
              </div><br>
              <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
                <?php
                $sql = "SELECT * FROM wy_employees, emp_sched WHERE wy_employees.sched_id = emp_sched.sched_id ";
                ...
                <tr style="color: white">
                  ...
                  <td>
                    <button class="btn btn-default btn-flat sched_change" id="<?php echo $row['emp_code']; ?>">Change Schedule<i class="fas fa-editt"></i></button>
                  </td>
                </tr>
                <?php
                }
