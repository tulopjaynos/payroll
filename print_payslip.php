...
<div class="row">
  <div class="col-12"><br><br>
    ...
    <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info" >
      ...
      $sqlGross ="SELECT *, SUM(attendance_hour) AS Hours, emp_attendance.employee_id AS ID
      FROM emp_attendance 
      LEFT JOIN emp_list ON emp_list.emp_id = emp_attendance.employee_id
      ...
      GROUP BY emp_attendance.employee_id ORDER BY emp_list.emp_lname ASC, emp_list.emp_fname ASC, emp_position.position_title ASC, emp_list.emp_card ASC";
      ...
      $sqlAttendance = "SELECT * FROM emp_attendance WHERE attendance_date BETWEEN '$s' AND '$e' AND employee_id = '$id'";
      ...
      while ($rowAttendance = mysqli_fetch_array($resultAttendance)) {
        // Computation of late.
        $late_in_min = strtotime($rowAttendance['attendance_timein']) - strtotime($rowGross['emp_timein']);
        ...
        $overtime_in_hr = strtotime($rowAttendance['attendance_timeout']) - strtotime($rowGross['emp_timeout']);
      ...
      ?>
        ...
        <p align="center" style="background-color: #87CEFA">Employee Name: <b><?php echo $rowGross['emp_lname']?>,<?php echo $rowGross['emp_fname']?></b></p>
