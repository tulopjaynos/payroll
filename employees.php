...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background:#777777">
			...
			<section class="content" style="background:#E2E5DE">
				<div class="row" >
        			<div class="col-xs-12" >
						<div class="box">
					...
					<form method="post" role="form" data-toggle="validator" id="edit-emp-form">
						<div class="modal-body">
							...
							<div class="form-group" >
								<div class="row">
									<div class="col-sm-4">
										<label for="pf_account">Password</label>
		...
		<!--footer class="main-footer"style="background:gray">
