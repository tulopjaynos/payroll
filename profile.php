...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background:#777777">
												...
												<div class="row">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="identity_no" id="identity_no" value="<?php echo $data['identity_no']; ?>"disabled="disabled" />
														</div>
													</div>
													<!--div class="col-lg-3">
														<div class="form-group">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control datepicker" name="joining_date" id="joining_date" value="<?php echo $data['joining_date']; ?>" disabled="disabled" />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															<label for="blood_group">Position</label>
															<input type="text" class="form-control" name="blood_group" id="blood_group" value="<?php echo $data['blood_group']; ?>" disabled="disabled" />
														</div>
													</div>
													<!--div class="col-lg-3">
														<div class="form-group">
		...
		<strong> &copy; <?php echo date("Y");?> Online Payroll Management System | </strong>
		</footer-->
	</div>
