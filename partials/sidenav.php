...
<aside class="main-sidebar" style="background:#00162A">
	<section class="sidebar">
		...
		<ul class="sidebar-menu" style="background:#00162A">
			<li class="header" style="background:#00162A">NAVIGATION</li>
			<?php if ( $_SESSION['Login_Type'] == 'admin' ) { ?>
				<li class="<?php echo $page_name == "attendance" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>attendance/">
						<i class="fa fa-calendars"></i> <span>Attendance</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "employees" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>employees/">
						<i class="fa fa-userss"></i> <span>Employees Section</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "QR" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>QR/">
						<i class="fa fa-userss"></i> <span>Create QR Code</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "salaries" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>salaries/">
						<i class="fa fa-moneys"></i> <span>Salary Slips</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "leaves" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>leaves/">
						<i class="fa fa-sign-outs"></i> <span>Leave Management</span>
					</a>
				</li>
				<li></li>
				<li class="<?php echo $page_name == "payheads" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>payheads/">
						<i class="fa fa-gratipays"></i> Pay Heads
					</a>
				</li>
			...
			<?php } else { ?>
				...
				<li class="<?php echo $page_name == "leaves" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>leaves/">
						<i class="fa fa-sign-outs"></i> <span>Leaves</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "holidays" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>holidays/">
						<i class="fa fa-calendar-check-os"></i> <span>Holidays</span>
					</a>
				</li>
			<?php } ?>
		</ul>
