<header class="main-header" >
	<a href="<?php echo BASE_URL; ?>" class="logo" style="background:#343d52">
		<span class="logo-mini"><b>P</b>M S</span>
		<span class="logo-lg" ><b>Online Payroll</b> </span>
	</a>
	<nav class="navbar navbar-static-top" role="navigation" style="background:#777777">
