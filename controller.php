...
if(isset($_POST['add_employee']))
{
  ...
  $query = "INSERT INTO emp_list (emp_card, emp_fname, emp_lname, emp_position, emp_address, emp_contact, emp_gender, emp_timein, emp_timeout, sched_id, emp_regdate, emp_password)
                          VALUES ('$tag', '$fname', '$lname', '$position', '$address', '$contact', '$gender', '$in', '$out', '$sched', '$regdate', '$passwrd')";
    ...
    while($row = mysqli_fetch_array($result))
    {
         ...
         $output .= '
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="update_password" value="'.$passwrd.'" placeholder="">
                </div>
              </div>
              ';
    }
...
if(isset($_POST["emp_update"]))
 {
   ...
   $passwrd = $_POST['update_password'];

   $sql = "UPDATE emp_list SET emp_fname = '".$fname."', emp_lname = '".$lname."', emp_address = '".$address."', emp_contact = '".$contact."', emp_gender = '".$gender."', emp_password = '".$passwrd."'
   WHERE emp_id = '".$card."'";
   $result = mysqli_query($db, $sql);
